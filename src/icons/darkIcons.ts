import { Bold, Brush, BrushCleaning, Check, ChevronDown, ChevronRight, Circle, CloudDownload, CornerUpLeft, CornerUpRight, Ellipsis, Eraser, FilePlus2, FileText, FolderInput, Hand, Heart, Highlighter, Image, Images, ImageUp, Italic, Layers, Menu, Minus, MoveRight, PaintBucket, Palette, PartyPopper, Pen, PenLine, PenToolIcon, Plus, RectangleHorizontal, Shredder, Slash, Spline, Square, SquareDashedMousePointer, Trash, Triangle, Type, Underline } from 'lucide-react';
export const darkIcons = {
    ...
    RectangleOutlineIcon: RectangleHorizontal,
    ...
    RectangleIcon: RectangleHorizontal, // Hình chữ nhật
