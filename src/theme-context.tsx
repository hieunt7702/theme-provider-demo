...
export type ThemeType = "default" | "light" | "dark" | "children";
...
interface IconSet {
    ...
    PencelOutline: React.ComponentType<any>;
    BsFonts: React.ComponentType<any>;
    FiMinus: React.ComponentType<any>;
    GrHomeOption: React.ComponentType<any>;
    GrUndo: React.ComponentType<any>;
    GrRedo: React.ComponentType<any>;
    RxDividerHorizontal: React.ComponentType<any>;
